...
namespace Sand
{
    ...
    public class Sand : Game
    {
            ...
            ThreadStart fontThread = delegate
                                     {
                                         ...
                                         Storage.AddFont("Calibri24Bold",
                                                         Content.Load<SpriteFont>("Fonts/Calibri24Bold"));
                                         Storage.AddFont("Calibri32", Content.Load<SpriteFont>("Fonts/Calibri32"));
                                         Storage.AddFont("Calibri32Bold",
                                                         Content.Load<SpriteFont>("Fonts/Calibri32Bold"));
                                         Storage.AddFont("Calibri120Bold",
                                                         Content.Load<SpriteFont>("Fonts/Calibri120Bold"));
                                         Storage.AddFont("Calibri400Bold",
                                                         Content.Load<SpriteFont>("Fonts/Calibri400Bold"));
            ...
            ThreadStart soundThread = delegate
                                      {
                                          ...
                                          Storage.AddSound("SandBurning",
                                                           Content.Load<SoundEffect>("Sounds/sand_burning_loop"));

                                          Storage.AddSound("DefenseClass1",
                                                           Content.Load<SoundEffect>("Sounds/Defense_1"));
                                          Storage.AddSound("OffenseClass1",
                                                           Content.Load<SoundEffect>("Sounds/Offense_1"));
                                          Storage.AddSound("SupportClass1",
                                                           Content.Load<SoundEffect>("Sounds/Support_1"));

                                          Storage.AddSound("DefenseClass2",
                                                           Content.Load<SoundEffect>("Sounds/Defense_2"));
                                          Storage.AddSound("OffenseClass2",
                                                           Content.Load<SoundEffect>("Sounds/Offense_2"));
                                          Storage.AddSound("SupportClass2",
                                                           Content.Load<SoundEffect>("Sounds/Support_2"));

                                          Storage.AddSound("DefenseClass3",
                                                           Content.Load<SoundEffect>("Sounds/Defense_3"));
                                          Storage.AddSound("OffenseClass3",
                                                           Content.Load<SoundEffect>("Sounds/Offense_3"));
                                          Storage.AddSound("SupportClass3",
                                                           Content.Load<SoundEffect>("Sounds/Support_3"));

                                          Storage.AddSound("BlinkDrive", Content.Load<SoundEffect>("Sounds/blinkdrive"));

                                          Storage.AddSound("BoostDrive_Start",
                                                           Content.Load<SoundEffect>("Sounds/BoostDrive_Start"));
                                          Storage.AddSound("BoostDrive_Stop",
                                                           Content.Load<SoundEffect>("Sounds/BoostDrive_Stop"));
                                          Storage.AddSound("BoostDrive_Engine",
                                                           Content.Load<SoundEffect>("Sounds/BoostDrive_Engine"));

                                          Storage.AddSound("WinkDrive_Start",
                                                           Content.Load<SoundEffect>("Sounds/WinkDrive_Start"));
                                          Storage.AddSound("WinkDrive_Stop",
                                                           Content.Load<SoundEffect>("Sounds/WinkDrive_Stop"));
                                          ...
                                          Storage.AddSound("FlameCharge",
                                                           Content.Load<SoundEffect>("Sounds/FlameCharge"));
                                          Storage.AddSound("PressureCharge",
                                                           Content.Load<SoundEffect>("Sounds/PressureCharge"));

                                          Storage.AddSound("EMP", Content.Load<SoundEffect>("Sounds/EMP"));
                                          Storage.AddSound("Ground", Content.Load<SoundEffect>("Sounds/Ground"));

                                          Storage.IntroMusic =
                                              Content.Load<SoundEffect>("Music/theme_intro").CreateInstance();
                                          Storage.LoopMusic =
            ...
            ThreadStart spriteThread = delegate
                                       {
                                           ...
                                           Storage.AddSprite("OffenseClass",
                                                             Content.Load<Texture2D>("Textures/Classes/offense"));
                                           Storage.AddSprite("SupportClass",
                                                             Content.Load<Texture2D>("Textures/Classes/support"));

                                           Storage.AddSprite("DefenseClassLarge",
                                                             Content.Load<Texture2D>("Textures/Classes/DefenseLarge"));
                                           Storage.AddSprite("OffenseClassLarge",
                                                             Content.Load<Texture2D>("Textures/Classes/OffenseLarge"));
                                           Storage.AddSprite("SupportClassLarge",
                                                             Content.Load<Texture2D>("Textures/Classes/SupportLarge"));

                                           Storage.AddSprite("DefenseClassFilled",
                                                             Content.Load<Texture2D>("Textures/Classes/DefenseFilled"));
                                           Storage.AddSprite("OffenseClassFilled",
                                                             Content.Load<Texture2D>("Textures/Classes/OffenseFilled"));
                                           Storage.AddSprite("SupportClassFilled",
                                                             Content.Load<Texture2D>("Textures/Classes/SupportFilled"));

                                           Storage.AddSprite("BlinkDrive",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Mobilities/BlinkDrive"));
                                           Storage.AddSprite("BoostDrive",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Mobilities/BoostDrive"));
                                           Storage.AddSprite("WinkDrive",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Mobilities/WinkDrive"));

                                           Storage.AddSprite("Cannon",
                                                             Content.Load<Texture2D>("Textures/Tools/Weapons/Cannon"));

                                           Storage.AddSprite("Shield",
                                                             Content.Load<Texture2D>("Textures/Tools/Utilities/Shield"));
                                           Storage.AddSprite("ShieldCircle",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Utilities/ShieldCircle"));
                                           Storage.AddSprite("WhiteCircle",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Utilities/WhiteCircle"));
                                           Storage.AddSprite("ToolDot",
                                                             Content.Load<Texture2D>("Textures/Tools/Utilities/ToolDot"));

                                           Storage.AddSprite("Jet",
                                                             Content.Load<Texture2D>("Textures/Tools/Primaries/Jet"));
                                           Storage.AddSprite("Plow",
                                                             Content.Load<Texture2D>("Textures/Tools/Primaries/Plow"));
                                           Storage.AddSprite("Laser",
                                                             Content.Load<Texture2D>("Textures/Tools/Primaries/Laser"));

                                           Storage.AddSprite("SandCharge",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Primaries/SandCharge"));
                                           Storage.AddSprite("FlameCharge",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Primaries/FlameCharge"));
                                           Storage.AddSprite("PressureCharge",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Primaries/PressureCharge"));

                                           Storage.AddSprite("EMP",
                                                             Content.Load<Texture2D>("Textures/Tools/Weapons/EMP"));

                                           Storage.AddSprite("Ground",
                                                             Content.Load<Texture2D>("Textures/Tools/Utilities/Ground"));
                                           Storage.AddSprite("GroundCircle",
                                                             Content.Load<Texture2D>(
                                                                 "Textures/Tools/Utilities/GroundCircle"));
        ...
        private void ComputeTransform()
        {
            ...
            _renderTarget = new RenderTarget2D(GraphicsDevice, Graphics.PreferredBackBufferWidth,
